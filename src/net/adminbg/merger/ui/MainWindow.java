...
import net.adminbg.merger.AdminMerger;
...
//        taskDispatcher.addPropertyChangeListener(this);
    ...
    private void initComponents() {
     ...
     //   java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("net/adminbg/merger/io/message"); // NOI18N
        ...
        storeText.setText("/home/kakavidon/Dev/git/admin/AdminMerger/store/");
        storeText.setFocusable(false);
        storeText.setRequestFocusEnabled(false);

        shopText.setText("/home/kakavidon/Dev/git/admin/AdminMerger/shop/");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(mergeButton, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(shopText))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(shopButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(storeButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(shopText, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void storeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_storeButtonActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            outputArea.append(TEXTAREA_LOG_MESSAGE_STORE + fileName + NEW_LINE); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void shopButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shopButtonActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            outputArea.append(TEXTAREA_LOG_MESSAGE_SHOP + fileName + NEW_LINE); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void merge() {
        ...
        final Map<String, String> directories = new TreeMap<>();
        directories.put("/home/kakavidon/Dev/git/admin/AdminMerger/store", ".csv");
        directories.put("/home/kakavidon/Dev/git/admin/AdminMerger/shop", ".xlsx");
