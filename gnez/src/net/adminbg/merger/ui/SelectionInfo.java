...
/**
 * A simple class that holds information about user selection.
 * 
 * @author lnedelc
 */
public class SelectionInfo implements Comparable<SelectionInfo> {
	...
	public SelectionInfo(final Path path, final String extension,
	...
	public String toString() {
		return "SelectionInfo{" + "path=" + path + ", extension=" + extension
				+ ", className=" + className + '}';
	}
